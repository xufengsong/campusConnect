    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("cognee_nodeset_name", models.CharField(blank=True, max_length=255)),
                (
                    "project_id",
                    models.UUIDField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "day_of_week",
                    models.IntegerField(help_text="0=Monday, 1=Tuesday, etc."),
                ),
                (
                    "start_time",
                    models.IntegerField(
                        help_text="Hour of the day (e.g., 9 for 9:00 AM)"
                    ),
                ),
                ...
                (
                    "color",
                    models.CharField(
                        default="#8B7EF2", help_text="Hex color code", max_length=7
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
